...
if chart_type == "Histogram":
    fig = px.histogram(filtered_df, x=x_col, nbins=30, height=400)

elif chart_type == "Scatter":
    fig = px.scatter(filtered_df, x=x_col, y=y_col, height=400)

elif chart_type == "Boxplot":
    fig = px.box(filtered_df, x=x_col, y=y_col, height=400)

else:
    fig = px.histogram(filtered_df, x=x_col, color=x_col, height=400)
