...
#### 3) Model Development: Train a Decision Tree Classification model to predict diabetic/non-diabetic cases.
#### 4) Risk prediction: calculate and display diabetes risk probability based on patient medical parameters.
